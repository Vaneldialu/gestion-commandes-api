...
export class LignesCommandeSchema extends BaseModel {
  static $columns = ['commandeId', 'createdAt', 'id', 'nomProduit', 'prixUnitaireVente', 'quantite', 'updatedAt'] as const
  $columns = LignesCommandeSchema.$columns
  @column()
  ...
  @column()
  declare prixUnitaireVente: string
  @column()
